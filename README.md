...
For more info see the [How It Works](docs/How%20It%20Works.md) document.
...
- See [examples](examples/) for local advisory reproductions and their target-provenance boundary.
