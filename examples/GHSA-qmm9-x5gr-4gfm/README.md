...
```bash
go run ./examples/GHSA-qmm9-x5gr-4gfm
```

The example starts a local landing server on `127.0.0.1:39099`. The path carries nocapsec's nonce, and Hekto's vulnerable protocol-relative redirect sends the browser to that external origin.
